...
export default function EnhancedTopicDetail({
    topicId,
    isOpen,
    onClose,
    onLike,
    onSave
}: EnhancedTopicDetailProps) {
    ...
    if (error || !topic) {
        console.error('EnhancedTopicDetail - 加载错误:', error);
        return (
            <Dialog open={isOpen} onOpenChange={onClose}>
    ...
    console.log('EnhancedTopicDetail - 话题数据:', topic);
            ...
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="max-w-6xl max-h-[90vh] p-0 gap-0 overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
                    <div className="grid grid-cols-1 lg:grid-cols-5 h-[85vh]">
                                            ...
                                            <>
                                                ...
                                                >
                                                    <Button
                                                        variant="ghost"
                                                        size="icon"
                                                        className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-md hover:bg-white/20 text-white border border-white/20"
                                                        onClick={prevImage}
                                                    >
                                                        <ChevronLeft size={20} />
                                                    </Button>
                                                ...
                                                >
                                                    <Button
                                                        variant="ghost"
                                                        size="icon"
                                                        className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-md hover:bg-white/20 text-white border border-white/20"
                                                        onClick={nextImage}
                                                    >
                                                ...
                                                {/* 图片计数 */}
                                                <div className="absolute top-6 right-6 bg-black/30 backdrop-blur-sm text-white px-4 py-2 rounded-full text-sm font-medium border border-white/20">
                        ...
                        {/* 右侧：内容区域 */}
                        <div className="lg:col-span-2 flex flex-col h-full bg-white/80 backdrop-blur-sm">
                            {/* 头部 */}
