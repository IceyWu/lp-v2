...
const MapCardLarge: React.FC<MapCardLargeProps> = ({ data = {}, isDark = false, className = "h-64 w-full" }) => {
  ...
  if (!hasMapData) {
    return (
      <div className={`${className} rounded-xl overflow-hidden bg-gray-100 flex items-center justify-center`}>
